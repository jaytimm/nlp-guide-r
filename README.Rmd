...
A summary of some (more upstream) NLP workflows -- mostly using the [udpipe](https://github.com/bnosac/udpipe) and [corpus](https://github.com/patperry/r-corpus) packages.
...
```{r fig.height=4.75, message=FALSE, warning=FALSE}
