...
> Some functions for gathering current online news articles, PubMed
> abstracts, and tweets.
...
```
    ...
    ## [1] "@knowssomethings @M_llyWeasley @albiechaser @peterframpton"
    ## [2] "Weren’t they the ones involved w/#Insurrection #jan6 let"  
    ## [3] "them all cough on each other.There is enough stupid in the"
    ## [4] "world."
...
> tokens to document-level. This minor hack works, and the resulting
> annotation contains the same number of rows as the table generated by
> `pmtk_cast_tokens`.
...
|:--------------------|-----:|-------:|
| of Pigs             |     4|   5.582|
| Republican Party    |     4|   8.452|
| most powerful man   |     3|  11.620|
| infrastructure bill |    10|   7.002|
| Freudian slip       |     3|  12.359|
| have been           |    10|   6.064|
...
|:------------------------------|:--------|------:|----:|
| wiggle\_room                  | NN      |      2|    1|
| clear\_reaction               | AN      |      2|    1|
| relative\_quiet               | AN      |      2|    1|
| president\_expressed\_concern | NAN     |      3|    1|
| 12\_education                 | AN      |      2|    1|
...
```
    ...
    ##   ..@ i       : int [1:5994] 0 1 2 3 4 5 8 10 11 14 ...
    ##   ..@ p       : int [1:3377] 0 14 33 40 43 51 71 85 100 115 ...
    ##   ..@ Dim     : int [1:2] 20 3376
    ##   ..@ Dimnames:List of 2
    ##   .. ..$ : chr [1:20] "1" "10" "11" "12" ...
    ##   .. ..$ : chr [1:3376] "-" "," ":" "!" ...
    ##   ..@ x       : num [1:5994] 12 4 18 3 9 1 10 4 6 11 ...
    ##   ..@ factors : list()
...
```
    ...
    ## 1  Biden      yet  0.8758007    1
    ## 2  Biden  doesnot  0.8593962    2
    ## 3  Biden     want  0.8410016    3
    ## 4  Biden      I'm  0.8317614    4
    ## 5  Biden    guess  0.8293610    5
    ## 6  Biden     tell  0.8249049    6
    ## 7  Biden campaign  0.8085845    7
    ## 8  Biden     most  0.8011426    8
    ## 9  Biden     have  0.7974621    9
    ## 10 Biden  control  0.7935191   10
